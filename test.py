...
import json
import numpy as np
from api_helper import BestPolicy, get_current_state, 
import helper
    ...
    while max_step >= 0:
        ...
        while max_step >= 0:
            ...
            if world_state.number_of_observations_since_last_state > 0:
                ...
                terrain_data[~np.isin(terrain_data, list(helper.EXCLUSION))] = "stone"
                agent_y = observations.get("YPos", None)
                ...
                # Choose move
                move = best_policy.choose_move(state=state)
